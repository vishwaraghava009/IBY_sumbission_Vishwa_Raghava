...
from modules.text_to_speech.alltalk_tts.alltalk_tts_module import generate_audio
...
def generate_audio_endpoint():
    ...
    try:
        # Call the generate_audio function with the provided text and voice
        generate_audio(text, voice, output_file_name, json_output_path, language)

        # Wait until the JSON file is updated
        while not os.path.exists(json_output_path):
            time.sleep(1)
...
GROQ_API_KEY = "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"  # Replace with your actual Groq API key
