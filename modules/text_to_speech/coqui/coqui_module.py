...
def list_models():
    ...
    """
    try:
        # Create an instance of the ModelManager to list available models
...
def coqui_generate_tts():
    """
    Process request text with the loaded TTS model
        - expected request: {
            "text": text,
            "model_id": voiceId,
    ...
    try:
        ...
        language_id = request_json.get("language_id", None)
        speaker_id = request_json.get("speaker_id", None)
