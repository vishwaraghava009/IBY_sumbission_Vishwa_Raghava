...
from therapy import api_views
from django.conf import settings
from therapy.views import list_images_api
from therapy.api_views import CheckVideoExistenceAPI
...
urlpatterns = [
    ...
    path('api/check-video-existence/', CheckVideoExistenceAPI.as_view(), name='check_video_existence_api'),
